...
if buildIndex:
	...
	for i in range(201,220): #the range of documents to be parsed
		count = 0
		writer = ix.writer()

		### --- IMPORTANT --- ###
		fName = "t6/tweets" + str(i) + ".txt" #this path must point to wherever you have the tweet files. So you will need to change "../Part 1/tweets" to somethin else, depending on where you have the tweets stored.
		print "loading " + fName
		f = open(fName, 'rb')
		try:
